...
| --- | --- | --- | --- | --- |
| `data/dictionary/tr/` | Turkish dictionary entry JSON files and `SOURCE.md` | `../dictionary`, commit `7daa18787e4826810d651ea5885aa6487187b95e` | 1,696 evidence-enriched entry files | Staged, not in `RELEASE.json`; release metadata/checksums pending. |
