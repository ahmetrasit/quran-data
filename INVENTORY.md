...
| --- | --- | --- | --- | --- |
| `data/dictionary/tr/` | Turkish dictionary entry JSON files and `SOURCE.md` | `../dictionary`, commit `bf756f5d432bd84cf3ff7581c6d46eebb0e62473` | 1,682 evidence-enriched entry files | Staged, not in `RELEASE.json`; release metadata/checksums pending. |
